...
export const SmrCodes : SmrDetails[] = [
    ...
    {code:33,tabLabel:'GroundWater', formLabel:'GAEC 3 Groundwater',route:'groundwater'},
    {code:34,tabLabel:'Minimum Soil Cover', formLabel:'GAEC 4 Minimum Soil Cover',route:'minsoilcover'},
    {code:35,tabLabel:'Soil Erosion', formLabel:'GAEC 5 Soil Erosion',route:'soilerosion'},
    {code:36,tabLabel:'Som', formLabel:'GAEC 6 SOM ',route:'som'},
    {code:37,tabLabel:'Landscape Features', formLabel:'GAEC 7 Landscape Features',route:'landscapefeatures'},   
    ...
    {code:10,tabLabel:'Hormone', formLabel:'SMR 5 Hormones ',route:'hormone'},
    ...
    {code:14,tabLabel:'Pesticides', formLabel:'SMR 10 Plant Protection ',route:'plantprotection'},
    {code:141,tabLabel:'PesticidesWS', formLabel:'',route:'pesticidesws'},
    {code:19,tabLabel:'Welfare of Calves', formLabel:'SMR 11 Calf Welfare ',route:'calfwelfare'},
    {code:20,tabLabel:'Welfare of Pigs', formLabel:'SMR 12 Pig Welfare ',route:'pigwelfare'},
    {code:21,tabLabel:'Welfare of Animals', formLabel:'SMR 13 Animal Welfare ',route:'animalwelfare'},
    ...
    {code:38,tabLabel:'Young Farmer', formLabel:'Young Farmer ',route:'youngfarmer'},    
